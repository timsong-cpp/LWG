...
g++ %* -std=c++14 -DNDEBUG -O2 -o bin/lists.exe  src/date.cpp src/issues.cpp src/sections.cpp src/mailing_info.cpp src/report_generator.cpp src/lists.cpp src/process_issues.cpp src/issue_metadata.cpp
